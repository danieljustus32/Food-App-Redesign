...
import { Mic, MicOff, Volume2, X, Play, CheckCircle, ChevronRight, Pause } from "lucide-react";
...
export default function CookingMode() {
  ...
  useEffect(() => {
    ...
    if (SpeechRecognition) {
      ...
      recognition.onend = () => {
        // Auto-restart recognition if we are supposed to be listening and not speaking
  ...
  // Use refs for the event handlers to read latest state
  ...
  // We need to use a function or ref here because handleNextStep is called from speech recognition callback
  // which might have stale closures. We'll use a functional state update.
      ...
      <div className="flex items-center justify-between p-6 z-10">
        ...
        <button 
          ...
          className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors ${
            isListening ? 'bg-primary text-white shadow-[0_0_15px_rgba(255,50,50,0.5)]' : 'bg-white/10 text-white/50'
          }`}
        >
