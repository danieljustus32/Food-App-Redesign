    ...
    >
      <Card className="w-full h-full overflow-hidden rounded-3xl shadow-xl relative border-0 touch-none">
        ...
        <motion.div
          ...
          className="absolute top-8 left-8 border-4 border-destructive text-destructive rounded-xl px-4 py-2 text-4xl font-bold uppercase tracking-wider -rotate-12 z-10"
        >
          PASS
        </motion.div>
